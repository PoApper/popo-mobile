...
const EquipReservationList: React.FC<ReservationListProps> = ({
  navigation,
  refreshKey,
  refreshing,
  onRefresh,
  ...
  const [selectedReservation, setSelectedReservation] =
    useState<EquipmentReservation | null>(null);
  ...
  const openModal = (item: EquipmentReservation) => {
                    ...
                    return (
                      <>
                        ...
                        <View style={styles.modalDetailSection}>
                          ...
                          {selectedReservation.equipments.map(
                            (equipment: Equipment) => (
                              <Text
                                key={equipment.uuid}
                                style={[
